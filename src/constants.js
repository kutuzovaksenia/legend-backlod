...
export const PRIORITY_META = {
  'Высокий': { color: '#FF385C', bg: '#FFF0F3' },
  'Средний':  { color: '#E6A800', bg: '#FFFAE0' },
  'Низкий':   { color: '#B0B0B0', bg: '#F5F5F5' },
}
...
export const COMPLEXITY_META = {
  'Быстро': { color: '#00A651', bg: '#E6F9EE', icon: '⚡' },
  'Средне': { color: '#E6A800', bg: '#FFFAE0', icon: '◑' },
  'Сложно': { color: '#FF385C', bg: '#FFF0F3', icon: '◆' },
}

export const GOAL_PALETTE = [
  '#FF385C','#0070F3','#7C3AED','#00A651',
  '#E6A800','#059669','#DC6F00','#0891B2',
]
